...
class Campo {
  ...
  final List<Campo> vizinhos =
      []; //Lista que define os campos adjacentes ao campo em destaque
  ...
  void adicionarVizinho(Campo vizinho) {
    //Adiciona os campos adjacentes ao campo de destaque
  ...
  void minar() {
    //Método que mina o campo diretamente na variável
    _minado = true;
  }

  void reiniciar() {
    //Reinicia os métodos para que o game possa ser recomeçado
    _aberto = false;
    _flag = false;
    _minado = false;
    _explodido = false;
  ...
  void alternarFlag() {
    //Adiciona ou remove a Flag do campo, isto independe de estar minado ou não
    if (_aberto == false) {
      _flag = !_flag;
    }
  }
  ...
  bool get resolvido {
    //Getter para saber se o campo esta resolvido
  ...
  bool get vizinhancaSegura {
    //Getter para saber se tem bombas aos campos adjacentes ao campo de destaque
    return vizinhos.every((v) => !v.minado);
  }

  int get qtdeMinasNaVizinhanca {
    //Quantifica as bombas dos campos adjacentes ao campo de destaque
